...
model11<-lm(change.gdp~instrument+Year+Country.Code,data=country.data)
...
stargazer(model11,model12,model13,
          keep=c("instrument","fitted.values"),
          covariate.labels=c("Instrument","Fitted Values"),
          column.labels=c("Reduced Form","First Stage","IV Regression"),style="aer",intercept.bottom=F,
